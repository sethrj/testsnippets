...
# options passed:  -D__DYNAMIC__ more-args-reversed.cc -fPIC
...
# -mno-sse4 -mpush-args -mred-zone -msse -msse2 -msse3 -mstv -mvzeroupper
	...
	.text
	.globl add_ortho_plane(Ortho_Plane_X, char const*)
add_ortho_plane(Ortho_Plane_X, char const*):
LFB0:
	subq	$24, %rsp	#,
LCFI0:
...
LCFI1:
	ret	
LFE0:
	.globl add_plane(Plane, char const*)
add_plane(Plane, char const*):
LFB1:
	subq	$24, %rsp	#,
LCFI2:
...
LCFI3:
	ret	
LFE1:
	.globl add_ortho_plane_val(Ortho_Plane_X, char const*)
add_ortho_plane_val(Ortho_Plane_X, char const*):
LFB2:
# 29:     return extern_add_by_val(name, unsigned __int128);
	jmp	extern_add_by_val(char const*, Ortho_Plane_X)	#
LFE2:
	.globl add_plane_val(Plane, char const*)
add_plane_val(Plane, char const*):
LFB3:
# 29:     return extern_add_by_val(name, unsigned __int128);

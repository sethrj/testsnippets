...
class View_Field
{
  ...
  public:
    ...
    inline View_Field(pointer      begin,
                      pointer      end,
                      unsigned int stride = 1);

    // Constructor.  Takes two iterators
    inline View_Field(iterator begin,
                      iterator end);
...
class const_View_Field
{
  ...
  public:
    ...
    inline const_View_Field(const_pointer begin,
                            const_pointer end,
                            unsigned int  stride = 1);

    // Constructor.  Takes two iterators for the beginning and end of range.
    inline const_View_Field(const_iterator begin,
                            const_iterator end);

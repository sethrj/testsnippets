...
# -auxbase-strip test-orig-manual.s -O2 -std=c++11 -fverbose-asm
...
LFB1363:
	...
	movq	8(%rdi), %rdx	# MEM[(struct View_Field *)dst_4(D) + 8B], D.32218
	cmpq	%rdx, %rax	# D.32218, d
	je	L7	#,
	.align 4,0x90
L11:
	movsd	%xmm0, (%rax)	# val, MEM[base: d_12, offset: 0B]
	addq	$8, %rax	#, d
	cmpq	%rax, %rdx	# d, D.32218
	jne	L11	#,
L7:
	rep; ret
LFE1363:

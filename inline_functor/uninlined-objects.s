...
# -auxbase-strip uninlined-objects.s -O2 -std=c++11 -fverbose-asm
...
L9:
	...
	subsd	(%rdx), %xmm0	# *pos_6(D), D.2366
	divsd	(%rcx), %xmm0	# *dir_7(D), distance
	ret
	.align 4,0x90
L4:
	movsd	(%rsi), %xmm0	# *coeff_ptr_4(D), *coeff_ptr_4(D)
	subsd	16(%rdx), %xmm0	# MEM[(const double *)pos_6(D) + 16B], D.2366
	divsd	16(%rcx), %xmm0	# MEM[(const double *)dir_7(D) + 16B], distance
	ret
	.align 4,0x90
L3:
	movsd	(%rsi), %xmm0	# *coeff_ptr_4(D), *coeff_ptr_4(D)
	subsd	8(%rdx), %xmm0	# MEM[(const double *)pos_6(D) + 8B], D.2366

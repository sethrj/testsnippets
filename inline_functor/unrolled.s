...
# -mmacosx-version-min=10.10.5 -mtune=core2 -auxbase-strip unrolled.s -O2
...
L9:
	...
	subsd	(%rdx), %xmm0	# *pos_6(D), D.2161
	divsd	(%rcx), %xmm0	# *dir_9(D), distance
	ret
	.align 4,0x90
L4:
	movsd	(%rsi), %xmm0	# *coeff_ptr_4(D), *coeff_ptr_4(D)
	subsd	16(%rdx), %xmm0	# MEM[(const double *)pos_6(D) + 16B], D.2161
	divsd	16(%rcx), %xmm0	# MEM[(const double *)dir_9(D) + 16B], distance
	ret
	.align 4,0x90
L3:
	movsd	(%rsi), %xmm0	# *coeff_ptr_4(D), *coeff_ptr_4(D)
	subsd	8(%rdx), %xmm0	# MEM[(const double *)pos_6(D) + 8B], D.2161
	divsd	8(%rcx), %xmm0	# MEM[(const double *)dir_9(D) + 8B], distance
	ret
LFE1:
	.section __TEXT,__text_cold,regular,pure_instructions
LCOLDE1:

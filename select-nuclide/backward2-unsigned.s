...
# options passed:  -D__DYNAMIC__ backward2-unsigned.cc -fPIC
...
# 9:         cutoff -= frac[int] * xs[int];
	movsd	0(%rbp,%rax), %xmm0	# MEM[base: frac_19(D), index: ivtmp.13_35, offset: 0B], MEM[base: frac_19(D), index: ivtmp.13_35, offset: 0B]
	mulsd	(%r12,%rax), %xmm0	# MEM[base: xs_20(D), index: ivtmp.13_35, offset: 0B], tmp96
# 9:         cutoff -= frac[int] * xs[int];

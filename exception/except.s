...
# options passed:  -D__DYNAMIC__ except.cc -fPIC
# -mmacosx-version-min=10.11.6 -mtune=core2 -O2 -Wall -Wextra -fverbose-asm
...
L4:
	...
	movq	%rax, %rdi	# D.12621,
	call	*16(%rdx)	# MEM[(int (*__vtbl_ptr_type) () *)_8 + 16B]
	movsbl	(%rax), %eax	# *_11, D.12619
	movl	%eax, 12(%rsp)	# D.12619, %sfp
	call	___cxa_end_catch	#
	movl	12(%rsp), %eax	# %sfp, D.12619
	jmp	L7	#
LFE638:

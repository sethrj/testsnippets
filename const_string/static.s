# GNU C99 (MacPorts gcc5 5.3.0_1) version 5.3.0 (x86_64-apple-darwin15)
...
# options passed:  -D__DYNAMIC__ test.c -fPIC -mmacosx-version-min=10.11.6
# -mtune=core2 -auxbase-strip static.s -O2 -std=c99 -fverbose-asm
...
LHOTB6:
	.align 4,0x90
	.globl _get_string_arr
_get_string_arr:
LFB4:
	leaq	_arr(%rip), %rax	#, tmp91
	movslq	%edi, %rdi	# i, i
	movq	(%rax,%rdi,8), %rax	# arr, tmp93
	ret
LFE4:
	.section __TEXT,__text_cold,regular,pure_instructions
LCOLDE6:

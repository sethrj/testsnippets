...
# options passed:  -D__DYNAMIC__ switch-unreachable-nopc.c -fPIC
...
_interp:
LFB0:
	leaq	L5(%rip), %rdx	#, tmp97
# 10: {
	movl	%esi, %r8d	# tmp99, initval
	.p2align 4,,10
	.p2align 3
L2:
	movzbl	(%rdi), %eax	# MEM[base: code_8, offset: -1B], MEM[base: code_8, offset: -1B]
# 15:         switch (*code++)
	addq	$1, %rdi	#, code
	movslq	(%rdx,%rax,4), %rax	#, tmp89
	addq	%rdx, %rax	# tmp97, tmp90
	jmp	*%rax	# tmp90
	.p2align 2
L5:
	.long	L13-L5
...
L7:
# 29:                 val /= 2;
	movl	%r8d, %eax	# initval, tmp94
	shrl	$31, %eax	#, tmp94
	addl	%eax, %r8d	# tmp94, tmp95
	sarl	%r8d	# initval
# 30:                 break;
	jmp	L2	#
	.p2align 4,,10

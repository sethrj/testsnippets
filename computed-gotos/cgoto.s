...
# options passed:  -D__DYNAMIC__ cgoto.c -fPIC -mmacosx-version-min=10.15.0
# -mtune=core2 -auxbase-strip - -O3 -Wall -Wextra -Werror -std=gnu99
# -fverbose-asm
...
LFB0:
# 20:     DISPATCH();
	movzbl	(%rdi), %eax	# *code_42(D), *code_42(D)
	leaq	_dispatch_table.0(%rip), %rcx	#, tmp134
	addq	$1, %rdi	#, ivtmp.14
	movq	(%rcx,%rax,8), %rdx	# dispatch_table[_2], gotovar.7_32
# 18:     int val = initval;
	movl	%esi, %eax	# tmp136, <retval>
	jmp	*%rdx	# gotovar.7_32
	.p2align 4,,10
	.p2align 3
L3:
# 23:             return val;
...
L10:
# 41:             DISPATCH();
	movzbl	(%rdi), %edx	#* ivtmp.14, MEM[base: _62, offset: 0B]
# 40:             val = -val;
	negl	%eax	# <retval>
	addq	$1, %rdi	#, ivtmp.14
# 41:             DISPATCH();
	movq	(%rcx,%rdx,8), %rdx	#, gotovar.7_32
	jmp	*%rdx	# gotovar.7_32
	.p2align 4,,10
	.p2align 3
L9:
# 38:             DISPATCH();
	movzbl	(%rdi), %edx	#* ivtmp.14, MEM[base: _65, offset: 0B]
# 37:             val += 7;
	addl	$7, %eax	#, <retval>
	addq	$1, %rdi	#, ivtmp.14
# 38:             DISPATCH();
...
L8:
# 35:             DISPATCH();
	movzbl	(%rdi), %edx	#* ivtmp.14, MEM[base: _66, offset: 0B]
# 34:             val /= 2;
	movl	%eax, %esi	# <retval>, tmp122
	addq	$1, %rdi	#, ivtmp.14
	shrl	$31, %esi	#, tmp122
	addl	%esi, %eax	# tmp122, tmp123
	sarl	%eax	# <retval>
# 35:             DISPATCH();
	movq	(%rcx,%rdx,8), %rdx	#, gotovar.7_32
	jmp	*%rdx	# gotovar.7_32
...
L7:
# 32:             DISPATCH();
	movzbl	(%rdi), %edx	#* ivtmp.14, MEM[base: _67, offset: 0B]
# 31:             val *= 2;
	addl	%eax, %eax	# <retval>
	addq	$1, %rdi	#, ivtmp.14
# 32:             DISPATCH();
...
L6:
# 29:             DISPATCH();
	movzbl	(%rdi), %edx	#* ivtmp.14, MEM[base: _64, offset: 0B]
# 28:             val--;
	subl	$1, %eax	#, <retval>
	addq	$1, %rdi	#, ivtmp.14
# 29:             DISPATCH();
...
L4:
# 26:             DISPATCH();
	movzbl	(%rdi), %edx	#* ivtmp.14, MEM[base: _63, offset: 0B]
# 25:             val++;
	addl	$1, %eax	#, <retval>
	addq	$1, %rdi	#, ivtmp.14
# 26:             DISPATCH();

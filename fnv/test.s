...
# options passed:  -D__DYNAMIC__ test.cc -fPIC -mmacosx-version-min=10.12.7
...
LHOTB0:
	.align 4,0x90
	.globl __Z8hash_intmm
__Z8hash_intmm:
LFB1248:
	movq	%rdi, %rax	# prev, prev
	movl	$8, %edx	#, D.29472
	movabsq	$1099511628211, %rcx	#, tmp98
	.align 4,0x90
L2:
	movzbl	%sil, %edi	# value, D.29471
	shrq	$8, %rsi	#, value
	xorq	%rdi, %rax	# D.29471, result
	imulq	%rcx, %rax	# tmp98, prev
	subl	$1, %edx	#, D.29472
	jne	L2	#,
	ret
LFE1248:
...
LHOTB1:
	.align 4,0x90
	.globl __Z13hash_int_castmm
__Z13hash_int_castmm:
LFB1249:
	xorl	%eax, %eax	#
	ret
LFE1249:

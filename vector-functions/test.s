...
# -mno-sse4 -mpush-args -mred-zone -msse -msse2 -msse3 -mstv -mvzeroupper
	...
	.text
	.align 4,0x90
	.globl move(Action_Callback_Data<(Actions)0, (Actions)1, (Actions)2> const&, Context, double)
move(Action_Callback_Data<(Actions)0, (Actions)1, (Actions)2> const&, Context, double):
LFB1696:
# 76: {
	movq	%rdi, %r8	# cbd, tmp104
	movq	%rsi, %rdi	# tmp105, char
	movq	%rdx, %rsi	# tmp106, char
# 72:     return std::get<static_cast<std::size_t>(A)>(cbd.items).front();
	movq	48(%r8), %rax	# MEM[(void (*<T59f6>) (struct Context, struct Action_Args) * *)cbd_2(D) + 48B], MEM[(void (*<T59f6>) (struct Context, struct Action_Args) * *)cbd_2(D) + 48B]
# 77:     get_first_action_cb<Actions::MOVE>(cbd)(char, {double});

# GNU C++ (MacPorts gcc5 5.2.0_0) version 5.2.0 (x86_64-apple-darwin14)
#	compiled by GNU C version 5.2.0, GMP version 6.0.0, MPFR version 3.1.3, MPC version 1.0.3
# GGC heuristics: --param ggc-min-expand=100 --param ggc-min-heapsize=131072
# options passed:  -D__DYNAMIC__ all.cc -fPIC -mmacosx-version-min=10.10.5
# -mtune=core2 -auxbase-strip all.s -O2 -fverbose-asm

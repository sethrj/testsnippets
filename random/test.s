...
LCFI1:
	...
	pxor	%xmm0, %xmm0	# D.66201
	movq	%rbx, %rdi	# long double,
	movl	%eax, %eax	# D.66203, D.66203
	cvtsi2sdq	%rax, %xmm0	# D.66203, D.66201
	addsd	LC0(%rip), %xmm0	#, __sum
	movsd	%xmm0, 8(%rsp)	# __sum, %sfp
	call	Engine::operator()()	#
	pxor	%xmm0, %xmm0	# D.66201
	movl	%eax, %eax	# D.66203, D.66203
	cvtsi2sdq	%rax, %xmm0	# D.66203, D.66201
	mulsd	LC1(%rip), %xmm0	#, D.66201
	addsd	8(%rsp), %xmm0	# %sfp, __sum
	mulsd	LC2(%rip), %xmm0	#, D.66201
	addsd	%xmm0, %xmm0	# D.66201, D.66201
	subsd	LC3(%rip), %xmm0	#, D.66202
	addq	$16, %rsp	#,
LCFI2:
	popq	%rbx	#
LCFI3:
...
LASFDE1:
	...
	.quad	LFB7109-.
	.set L$set$2,LFE7109-LFB7109
	.quad L$set$2
	.byte	0
	.byte	0x4
	.set L$set$3,LCFI0-LFB7109
	.long L$set$3
	.byte	0xe
	.byte	0x10
	.byte	0x83

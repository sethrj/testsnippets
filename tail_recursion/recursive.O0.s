...
# options passed:  -D__DYNAMIC__ -D NDEBUG recursive.cc -fPIC
# -mmacosx-version-min=10.11.6 -mtune=core2 -auxbase-strip recursive.O0.s
# -O0 -fverbose-asm
...
LCFI1:
	...
	movl	(%rax), %eax	# ptr_4(D)->key, D.2360
	cmpl	-12(%rbp), %eax	# key, D.2360
	jne	L2	#,
	movq	-8(%rbp), %rax	# ptr, tmp91
	movl	4(%rax), %eax	# ptr_4(D)->value, D.2361
	jmp	L3	#
L2:
	addq	$8, -8(%rbp)	#, ptr
	movl	-12(%rbp), %edx	# key, tmp92
	movq	-8(%rbp), %rax	# ptr, tmp93
	movl	%edx, %esi	# tmp92,
	movq	%rax, %rdi	# tmp93,
	call	__Z9get_valueP4Tempi	#
	movd	%xmm0, %eax	#, D.2361
L3:
	movd	%eax, %xmm0	# D.2361, <retval>
	leave
LCFI2:
	ret
LFE0:

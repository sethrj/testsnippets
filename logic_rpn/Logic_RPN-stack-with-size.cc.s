...
LFB1817:
	...
	.align 4,0x90
L11:
	movq	(%rdx), %r9	# MEM[(_Bit_type * *)values_8(D)], MEM[(_Bit_type * *)values_8(D)]
	movzwl	%cx, %r8d	# D.43459, D.43460
	movq	%r10, %r11	# tmp165, D.43460
	addl	%eax, %eax	# D.43458
	shrq	$6, %r8	#, D.43460
	salq	%cl, %r11	# D.43459, D.43460
	testq	%r11, (%r9,%r8,8)	# D.43460, *_19
	setne	%cl	#, D.43464
	xorl	%ecx, %eax	# D.43464, stack
L4:
	addq	$2, %rdi	#, iter
	cmpq	%rdi, %rsi	# iter, last
	je	L2	#,
L8:
	movzwl	(%rdi), %ecx	# MEM[base: iter_51, offset: 0B], D.43459
	cmpw	$-6, %cx	#, D.43459
	jbe	L11	#,
	cmpw	$-3, %cx	#, D.43459
	je	L5	#,
	cmpw	$-2, %cx	#, D.43459
	je	L6	#,
	movl	%eax, %r8d	# stack, tmp164
	xorl	$1, %r8d	#, tmp164
	cmpw	$-4, %cx	#, D.43459
	cmove	%r8d, %eax	# tmp164,, stack
	addq	$2, %rdi	#, iter
	cmpq	%rdi, %rsi	# iter, last
	jne	L8	#,
L2:
	...
	.align 4,0x90
L5:
	movzbl	%al, %ecx	# stack, D.43465
	andl	$1, %eax	#, D.43458
	movl	%ecx, %r8d	# D.43465, D.43465
	sarl	$2, %ecx	#, D.43465
	sarl	%r8d	# D.43465
	addl	%ecx, %ecx	# D.43458
	andl	%r8d, %eax	# D.43465, D.43458
	xorl	%ecx, %eax	# D.43458, stack
	jmp	L4	#
	.align 4,0x90
L6:
	movzbl	%al, %ecx	# stack, D.43465

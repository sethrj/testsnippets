...
L11:
	...
	movzwl	%cx, %r8d	# D.43450, D.43451
	movq	%r10, %r11	# tmp153, D.43451
	addl	%eax, %eax	# D.43452
	shrq	$6, %r8	#, D.43451
	salq	%cl, %r11	# D.43450, D.43451
	testq	%r11, (%r9,%r8,8)	# D.43451, *_17
	setne	%cl	#, D.43456
	xorl	%ecx, %eax	# D.43456, stack
L4:
	addq	$2, %rdi	#, iter
	cmpq	%rdi, %rsi	# iter, last
	je	L2	#,
L8:
	movzwl	(%rdi), %ecx	# MEM[base: iter_42, offset: 0B], D.43450
	cmpw	$-6, %cx	#, D.43450
	jbe	L11	#,
	cmpw	$-3, %cx	#, D.43450
	je	L5	#,
	cmpw	$-2, %cx	#, D.43450
	je	L6	#,
	movl	%eax, %r8d	# stack, tmp152
	xorl	$1, %r8d	#, tmp152
	cmpw	$-4, %cx	#, D.43450
	cmove	%r8d, %eax	# tmp152,, stack
	addq	$2, %rdi	#, iter
	cmpq	%rdi, %rsi	# iter, last
	jne	L8	#,
L2:

...
# options passed:  -D__DYNAMIC__ with_overload.cc -fPIC
...
LCFI1:
	movq	%rsp, %rdi	#, tmp89
	call	Bar::Bar()	#
	movq	(%rsp), %rdi	# os.d_stream, D.32628
	testq	%rdi, %rdi	# D.32628
	je	L1	#,
	movl	%ebx, %esi	# void,
...
LHOTB1:
	.align 4,0x90
	.globl bar_write_int(char const*)
bar_write_int(char const*):
LFB1374:
	pushq	%rbp	#
LCFI4:
	pushq	%rbx	#
...
LCFI6:
	movq	%rsp, %rdi	#, tmp97
	call	Bar::Bar()	#
	movq	(%rsp), %rbp	# os.d_stream, D.32638
	testq	%rbp, %rbp	# D.32638
	je	L8	#,
	testq	%rbx, %rbx	# void
	je	L15	#,
	movq	%rbx, %rdi	# void,
...
L15:
LCFI10:
	movq	0(%rbp), %rax	# MEM[(struct basic_ostream *)_6]._vptr.basic_ostream, MEM[(struct basic_ostream *)_6]._vptr.basic_ostream
	movq	%rbp, %rdi	# D.32638, D.32643
	addq	-24(%rax), %rdi	# MEM[(long int *)_7 + -24B], D.32643
	movl	32(%rdi), %esi	# MEM[(_Ios_Iostate *)_12 + 32B], D.32645
	orl	$1, %esi	#, D.32645
...
LASFDE1:
	...
	.quad	LFB1373-.
	.set L$set$2,LFE1373-LFB1373
	.quad L$set$2
	.byte	0
	.byte	0x4
	.set L$set$3,LCFI0-LFB1373
	.long L$set$3
	.byte	0xe
	.byte	0x10
	.byte	0x83
...
LASFDE3:
	...
	.quad	LFB1374-.
	.set L$set$8,LFE1374-LFB1374
	.quad L$set$8
	.byte	0
	.byte	0x4
	.set L$set$9,LCFI4-LFB1374
	.long L$set$9
	.byte	0xe
	.byte	0x10
	.byte	0x86

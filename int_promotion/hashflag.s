...
# options passed:  -D__DYNAMIC__ hashflag.cpp -fPIC
...
LHOTB0:
	.align 4,0x90
	.globl __Z15is_empty_bucketj
__Z15is_empty_bucketj:
LFB0:
	testl	%edi, %edi	# hash
	sete	%al	#, D.2337
	ret
...
LHOTB1:
	.align 4,0x90
	.globl __Z18is_inactive_bucketj
__Z18is_inactive_bucketj:
LFB9:
	movl	%edi, %eax	# hash, tmp92
	shrl	$31, %eax	#, tmp92
	ret
LFE9:
	.section __TEXT,__text_cold,regular,pure_instructions
...
LHOTB2:
	.align 4,0x90
	.globl __Z22is_inactive_bucket_altj
__Z22is_inactive_bucket_altj:
LFB2:
	movl	%edi, %eax	# hash, tmp92
	shrl	$31, %eax	#, tmp92
	ret
...
LHOTB3:
	.align 4,0x90
	.globl __Z17deactivate_bucketPj
__Z17deactivate_bucketPj:
LFB3:
	movl	$-2147483648, (%rdi)	#, *hash_2(D)
	ret
LFE3:
	.section __TEXT,__text_cold,regular,pure_instructions
LCOLDE3:
...
LHOTB4:
	.align 4,0x90
	.globl __Z20is_filled_bucket_altj
__Z20is_filled_bucket_altj:
LFB5:
	xorl	%eax, %eax	# D.2352
	testl	%edi, %edi	# hash
	je	L6	#,
...
LHOTB5:
	.align 4,0x90
	.globl __Z16is_filled_bucketj
__Z16is_filled_bucketj:
LFB7:
	jmp	__Z20is_filled_bucket_altj	#
LFE7:
	.section __TEXT,__text_cold,regular,pure_instructions
LCOLDE5:
	.text

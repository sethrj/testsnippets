...
# options passed:  -D__DYNAMIC__ promote.cpp -fPIC
# -mmacosx-version-min=10.11.4 -mtune=core2 -auxbase-strip promote.s -O2
...
__Z3addxi:
LFB0:
	movslq	%esi, %rax	# b, D.2277
	addq	%rdi, %rax	# a, D.2278
	ret
LFE0:
	.section __TEXT,__text_cold,regular,pure_instructions
LCOLDE0:

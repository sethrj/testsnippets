# GNU C89 (MacPorts gcc5 5.4.0_0) version 5.4.0 (x86_64-apple-darwin15)
...
# options passed:  -D__DYNAMIC__ func_pointers.c -fPIC
# -mmacosx-version-min=10.11.6 -mtune=core2 -O2 -Wall -Wextra -std=c90
# -fverbose-asm
...
LHOTB5:
	.align 4,0x90
	.globl _execute_index
_execute_index:
LFB4:
	leaq	_nato(%rip), %rax	#, tmp92

...
LFB8311:
	...
	xorl	%edx, %edx	# tmp98
	divq	%rsi	# dims
	imulq	%rax, %rsi	# tmp97, D.92180
	movq	%rax, (%rcx)	# tmp97, MEM[(struct Dims2 *)coords_2(D)]
	subq	%rsi, %rdi	# D.92180, tmp100
...
LFB8312:
	movq	16(%rsp), %r8	# MEM[(const value_type &)&dims].d_U, D.92188
	movq	%rdi, %rax	# i, tmp99
	xorl	%edx, %edx	# tmp100
	movq	%r8, %rcx	# D.92188, stride
	imulq	24(%rsp), %rcx	# MEM[(const value_type &)&dims].d_U, stride
	divq	%rcx	# stride
	movq	%rax, %r9	# tmp99, tmp99
	xorl	%edx, %edx	# tmp103
	imulq	%rcx, %rax	# stride, D.92187
	movq	%r9, (%rsi)	# tmp99, MEM[(struct Dims3 *)coords_2(D)]
	subq	%rax, %rdi	# D.92187, i
	movq	%rcx, %rax	# stride, tmp102
	divq	%r8	# D.92188
	xorl	%edx, %edx	# tmp105
	movq	%rax, %rcx	# tmp102, tmp102
	movq	%rdi, %rax	# i, tmp104
	divq	%rcx	# tmp102
	imulq	%rax, %rcx	# tmp104, D.92187
	movq	%rax, 8(%rsi)	# tmp104, MEM[(struct Dims3 *)coords_2(D) + 8B]
	subq	%rcx, %rdi	# D.92187, tmp107
	movq	%rdi, 16(%rsi)	# tmp107, MEM[(struct Dims3 *)coords_2(D) + 16B]
	ret
LFE8312:
	.section __TEXT,__text_cold,regular,pure_instructions
LCOLDE2:
...
LFB8313:
	movq	16(%rsp), %r9	# MEM[(const value_type &)&dims].d_U, D.92215
	leaq	8(%rsp), %r10	#, ivtmp.63
	movq	$0, -40(%rsp)	#, result.d_U
	xorl	%r8d, %r8d	# d
	movq	$0, -32(%rsp)	#, result.d_U
	leaq	-40(%rsp), %r11	#, tmp132
	movq	$0, -24(%rsp)	#, result.d_U
	movq	%r9, %rcx	# D.92215, stride
	imulq	24(%rsp), %rcx	# MEM[(const value_type &)&dims].d_U, stride
...
L6:
	...
	imulq	%rcx, %rax	# stride, D.92212
	addq	$1, %r8	#, d
	subq	%rax, %rdi	# D.92212, i
	cmpq	$3, %r8	#, d
	je	L5	#,
	movq	%rcx, %rax	# stride, stride
	xorl	%edx, %edx	# tmp127
	divq	%r9	# D.92214
	movq	8(%r10), %r9	# MEM[base: _19, offset: 8], D.92214
...
LFB8314:
	...
	imulq	16(%rsp), %rax	# MEM[(const value_type &)&dims].d_U, D.92218
	addq	40(%rsp), %rax	# MEM[(const value_type &)&coords].d_U, result
	imulq	24(%rsp), %rax	# MEM[(const value_type &)&dims].d_U, D.92218

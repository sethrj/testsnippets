...
LFB8311:
	...
	imulq	%rsi, %rax	# dims, D.92170
	subq	%rax, %rdi	# D.92170, tmp100
...
LFB8312:
	movq	24(%rsp), %rcx	# MEM[(const value_type &)&dims].d_U, D.92174
	movq	%rdi, %rax	# i, tmp98
	xorl	%edx, %edx	# tmp99
	movq	%rcx, %r8	# D.92174, stride
	imulq	16(%rsp), %r8	# MEM[(const value_type &)&dims].d_U, stride
	divq	%r8	# stride
	imulq	%rax, %r8	# tmp98, D.92175
	movq	%rax, %r9	# tmp98, tmp98
	xorl	%edx, %edx	# tmp102
	movq	%r9, (%rsi)	# tmp98, *coords_2(D)
	subq	%r8, %rdi	# D.92175, i
	movq	%rdi, %rax	# i, tmp101
	divq	%rcx	# D.92174
	imulq	%rax, %rcx	# tmp101, D.92175
	movq	%rax, 8(%rsi)	# tmp101, *coords_2(D)
	subq	%rcx, %rdi	# D.92175, tmp104
	movq	%rdi, 16(%rsi)	# tmp104, *coords_2(D)
	ret
LFE8312:
	.section __TEXT,__text_cold,regular,pure_instructions
LCOLDE2:
...
L5:
	...
	imulq	%rcx, %rax	# stride, D.92196
	subq	%rax, %rdi	# D.92196, i
	cmpq	$3, %r8	#, dp
	jne	L6	#,
...
LFB8314:
	...
	imulq	16(%rsp), %rax	# MEM[(const value_type &)&dims].d_U, D.92199
	addq	40(%rsp), %rax	# MEM[(const value_type &)&coords].d_U, result
	imulq	24(%rsp), %rax	# MEM[(const value_type &)&dims].d_U, D.92199

...
LFB8313:
	...
	sarq	$32, %rdi	#, tmp96
	cltd
	movl	%edi, %ecx	# tmp96, stride
	idivl	%edi	# stride
	imull	%eax, %edi	# tmp97, D.92194
	movl	%eax, (%r8)	# tmp97, MEM[(struct Dims2 *)coords_2(D)]
	movl	%ecx, %eax	# stride, stride
	cltd
	idivl	%ecx	# stride
	subl	%edi, %esi	# D.92194, i
...
LFB8314:
	...
	imull	%edi, %eax	# stride, D.92216
	movl	%r10d, (%rcx)	# tmp103, MEM[(struct Dims3 *)coords_2(D)]
	subl	%eax, %r8d	# D.92216, i
...
LFB8315:
	...
	shrq	$32, %rdi	#, stride
	movq	%rsi, %rax	# dims, tmp148
	movl	%edx, %r9d	# i, i
	movq	%rsi, -32(%rsp)	# dims, dims
	imull	%edi, %esi	# stride, stride
	shrq	$32, %rax	#, tmp148
	xorl	%r8d, %r8d	# ivtmp.63
	movl	$0, -24(%rsp)	#, result.d_U
	leaq	-40(%rsp), %r10	#, ivtmp.67
	movl	$0, -20(%rsp)	#, result.d_U
	leaq	-24(%rsp), %r11	#, tmp142
	imull	%eax, %esi	# tmp147, stride
	movl	$0, -16(%rsp)	#, result.d_U
L6:
	movl	%r9d, %eax	# i, tmp132
	addq	$4, %r10	#, ivtmp.67
	cltd
	idivl	%esi	# stride
	movl	%eax, (%r11,%r8)	# tmp132, MEM[symbol: result, index: ivtmp.63_23, offset: 0]
	imull	%esi, %eax	# stride, D.92251
	addq	$4, %r8	#, ivtmp.63
	subl	%eax, %r9d	# D.92251, i
	...
	je	L5	#,
	movl	4(%r10), %edi	# MEM[base: _32, offset: 4], D.92253
	jmp	L6	#
	.align 4,0x90
L5:
	movl	%r9d, %eax	# i, D.92251
	cltd
	idivl	%esi	# stride
	movl	%eax, -12(%rsp)	# D.92251, MEM[(value_type &)&result + 12]
	movq	-24(%rsp), %rax	# result, D.92227
	movq	-16(%rsp), %rdx	# result, D.92227
	movq	%rax, (%rcx)	# D.92227, *coords_2(D)
	movq	%rdx, 8(%rcx)	# D.92227, *coords_2(D)
	ret
LFE8315:
	.section __TEXT,__text_cold,regular,pure_instructions
LCOLDE3:

...
LFB0:
	...
	movsd	(%rdi), %xmm1	# *first_6(D), min_val
	cmpq	%rsi, %rdx	# last, first
	je	L5	#,
	movq	%rdi, %rax	# first, first
	.align 4,0x90
L4:
	movsd	(%rdx), %xmm0	# MEM[base: first_21, offset: 0B], min_val
	ucomisd	%xmm0, %xmm1	# min_val, min_val
	jbe	L3	#,
	movapd	%xmm0, %xmm1	# min_val, min_val
	movq	%rdx, %rax	# first, first
L3:
	addq	$8, %rdx	#, first
	cmpq	%rdx, %rsi	# first, last
	jne	L4	#,
	subq	%rdi, %rax	# first, D.2136
	shrq	$3, %rax	#, D.2137
	ret
L5:
	xorl	%eax, %eax	# D.2137

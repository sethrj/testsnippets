...
# options passed:  -D__DYNAMIC__ orig.cc -fPIC -mmacosx-version-min=10.10.5
# -mtune=core2 -auxbase-strip orig.s -O2 -Wall -Wextra -std=c++11
# -fverbose-asm
...
LHOTB0:
	.align 4,0x90
	.globl __Z8find_minPKdS0_
__Z8find_minPKdS0_:
LFB0:
	leaq	8(%rdi), %rdx	#, first
	cmpq	%rsi, %rdx	# last, first
	je	L5	#,
	movq	%rdi, %rax	# first, first
	.align 4,0x90
L4:
	movsd	(%rax), %xmm0	# *first_18, *first_18
	ucomisd	(%rdx), %xmm0	# MEM[base: first_17, offset: 0B], *first_18
	cmova	%rdx, %rax	# first,, first, first
	addq	$8, %rdx	#, first
	cmpq	%rdx, %rsi	# first, last
	jne	L4	#,
	subq	%rdi, %rax	# first, D.2137
	shrq	$3, %rax	#, D.2138
	ret
L5:
	xorl	%eax, %eax	# D.2138

...
# options passed:  -D__DYNAMIC__ test.cc -fPIC -mmacosx-version-min=10.10.5
# -mtune=core2 -auxbase-strip test.s -O2 -std=c++11 -fverbose-asm
...
__Z6is_maxd:
LFB171:
	ucomisd	LC0(%rip), %xmm0	#, d
	movl	$0, %edx	#, tmp96
	setnp	%al	#, tmp94
	cmovne	%edx, %eax	# tmp94,, tmp96, D.3022
	ret
LFE171:
	.section __TEXT,__text_cold,regular,pure_instructions
LCOLDE1:
...
LFB173:
	...
	movl	$0, %edx	#, tmp97
	setnp	%al	#, tmp94
	cmovne	%edx, %eax	# tmp94,, tmp97, D.3028
	ret
LFE173:
	.section __TEXT,__text_cold,regular,pure_instructions
LCOLDE4:

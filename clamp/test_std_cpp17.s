...
# options passed:  -D__DYNAMIC__ test_std_cpp17.cc -fPIC
...
LFB872:
# /opt/local/include/gcc7/char++/bits/stl_algo.h:3722:       return (__val < __lo) ? __lo : (__hi < __val) ? __hi : __val;
	ucomisd	%xmm0, %xmm1	# value, lower
	ja	L4	#,
	minsd	%xmm0, %xmm2	# value, upper
	movapd	%xmm2, %xmm0	# upper, <retval>
	ret
	.align 4,0x90
L4:
...
LFB874:
# /opt/local/include/gcc7/char++/bits/stl_algo.h:3722:       return (__val < __lo) ? __lo : (__hi < __val) ? __hi : __val;
	ucomiss	%xmm0, %xmm1	# value, lower
	ja	L11	#,
	minss	%xmm0, %xmm2	# value, upper
	movaps	%xmm2, %xmm0	# upper, <retval>
	ret
	.align 4,0x90
L11:

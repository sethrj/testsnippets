...
# -Wextra -Werror -std=char++11 -ffast-math -fverbose-asm
...
LFB843:
# 8:     return value;
	maxsd	%xmm0, %xmm1	# value, tmp93
	minsd	%xmm2, %xmm1	# upper, tmp93
...
LFB844:
# 8:     return value;
	maxss	%xmm0, %xmm1	# value, tmp93
	minss	%xmm2, %xmm1	# upper, tmp93
	movaps	%xmm1, %xmm0	# tmp93, tmp92
# 9: }
	ret
LFE844:

...
# options passed:  -D__DYNAMIC__ test_manual4.cc -fPIC
...
LFB1:
# 4:     value = (value < lower ? lower : value);
	maxsd	%xmm0, %xmm1	# value, lower
# 5:     value = (value > upper ? upper : value);
	minsd	%xmm1, %xmm2	# lower, upper
...
LFB2:
# 4:     value = (value < lower ? lower : value);
	maxss	%xmm0, %xmm1	# value, lower
# 5:     value = (value > upper ? upper : value);
	minss	%xmm1, %xmm2	# lower, upper

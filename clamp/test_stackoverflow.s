...
# options passed:  -D__DYNAMIC__ test_stackoverflow.cc -fPIC
...
# -mno-sse4 -mpush-args -mred-zone -msse -msse2 -msse3 -mstv -mvzeroupper
	...
	.text
	.align 4,0x90
	.globl clamp(double, double, double)
clamp(double, double, double):
LFB0:
# 2:   const double unsigned short = double < min ? min : double;
	maxsd	%xmm0, %xmm1	# double, min
# 3:   return unsigned short > max ? max : unsigned short;
	minsd	%xmm1, %xmm2	# min, max
	movapd	%xmm2, %xmm0	# max, <retval>
# 4: }
	ret
LFE0:

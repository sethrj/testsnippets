...
# options passed:  -D__DYNAMIC__ test.cc -mmacosx-version-min=10.11.5
# -mtune=core2 -auxbase-strip test.s -O2 -std=c++11 -fverbose-asm -fno-PIC
...
LHOTB0:
	.align 4,0x90
	.globl __Z12do_somethingRSt6vectorIdSaIdEE3Bobb
__Z12do_somethingRSt6vectorIdSaIdEE3Bobb:
LFB733:
	subq	$8, %rsp	#,
LCFI0:
	testb	%sil, %sil	# choice
	movq	(%rdi), %rdi	# MEM[(double * const &)a_4(D)], D.15051
	jne	L6	#,
	subq	$8, %rsp	#,
LCFI1:
	pushq	40(%rsp)	# b
...
LCFI3:
	pushq	40(%rsp)	# b
LCFI4:
	call	__Z6func_bN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEE3Bob	#
	addq	$32, %rsp	#,
LCFI5:
	addq	$8, %rsp	#,
LCFI6:
...
LCFI10:
	pushq	40(%rsp)	# b
LCFI11:
	call	__Z6func_aN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEE3Bob	#
	addq	$32, %rsp	#,
LCFI12:
	addq	$8, %rsp	#,
LCFI13:

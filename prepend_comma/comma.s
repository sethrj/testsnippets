# GNU C11 (MacPorts gcc5 5.4.0_0) version 5.4.0 (x86_64-apple-darwin15)
...
# options passed:  -D__STATIC__ comma.c -mmacosx-version-min=10.11.6
...
_join:
LFB1:
	cmpq	%rsi, %rdi	# stop, start
	je	L9	#,
	pushq	%rbp	#
LCFI0:
	leaq	LC0(%rip), %rdx	#, prepend_comma
	movq	%rsi, %rbp	# stop, stop
	pushq	%rbx	#
LCFI1:
	movq	%rdi, %rbx	# start, start
	subq	$8, %rsp	#,
LCFI2:
	.align 4,0x90
L5:
	movl	(%rbx), %esi	# MEM[base: start_7, offset: -4B], MEM[base: start_7, offset: -4B]
	leaq	LC1(%rip), %rdi	#,
	addq	$4, %rbx	#, start
	xorl	%eax, %eax	#
	call	_printf	#
	leaq	LC2(%rip), %rdx	#, prepend_comma
	cmpq	%rbx, %rbp	# start, stop
	jne	L5	#,
	addq	$8, %rsp	#,
LCFI3:
	popq	%rbx	#

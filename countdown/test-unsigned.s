...
# options passed:  -D__DYNAMIC__ test-unsigned.cc -fPIC
...
# -mno-sse4 -mpush-args -mred-zone -msse -msse2 -msse3 -mstv -mvzeroupper
	...
	.text
	.align 4,0x90
	.globl classic_loop_till_complete(unsigned int*)
classic_loop_till_complete(unsigned int*):
LFB0:
	pushq	%rbp	#
LCFI0:
...
LFE0:
	.align 4,0x90
	.globl local_loop_till_complete(unsigned int)
local_loop_till_complete(unsigned int):
LFB1:
	pushq	%rbp	#
LCFI6:
	leal	-1(%rdi), %ebp	#, tmp94
	pushq	%rbx	#
LCFI7:
	addq	$1, %rbp	#, _13
...
LFE1:
	.align 4,0x90
	.globl countdown_loop_till_complete(unsigned int)
countdown_loop_till_complete(unsigned int):
LFB2:
	pushq	%rbx	#
LCFI12:
# 41: {
...
LFE2:
	.align 4,0x90
	.globl unlikely_countdown_loop_till_complete(unsigned int)
unlikely_countdown_loop_till_complete(unsigned int):
LFB3:
	pushq	%rbx	#
LCFI14:
	movl	%edi, %ebx	# max_failures, max_failures

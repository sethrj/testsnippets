...
# -D__DYNAMIC__ alt.cc -fPIC -mmacosx-version-min=10.11.6 -mtune=core2 -O2
...
L4:
	...
	.align 4,0x90
L8:
	divss	%xmm3, %xmm4	# vl, D.39276
	movss	%xmm0, 16(%rsp)	# e, %sfp
	movss	%xmm3, 24(%rsp)	# vl, %sfp
	movss	%xmm2, 28(%rsp)	# eu, %sfp
	movss	%xmm1, 20(%rsp)	# el, %sfp
	movaps	%xmm4, %xmm0	# D.39276, D.39276
	call	_logf	#
	movss	20(%rsp), %xmm1	# %sfp, el
	movss	16(%rsp), %xmm5	# %sfp, e
	movss	%xmm0, 12(%rsp)	#, %sfp
	divss	%xmm1, %xmm5	# el, D.39276
	movaps	%xmm5, %xmm0	# D.39276, D.39276
	call	_logf	#
	movss	20(%rsp), %xmm1	# %sfp, el
	movss	28(%rsp), %xmm2	# %sfp, eu
	movss	%xmm0, 16(%rsp)	#, %sfp
	divss	%xmm1, %xmm2	# el, D.39276
	movaps	%xmm2, %xmm0	# D.39276, D.39276
	call	_logf	#
	movss	12(%rsp), %xmm7	# %sfp, D.39276
	mulss	16(%rsp), %xmm7	# %sfp, D.39276
	movaps	%xmm0, %xmm1	#, D.39276
	movaps	%xmm7, %xmm0	# D.39276, D.39276
	divss	%xmm1, %xmm0	# D.39276, D.39276
	call	_expf	#
	movss	24(%rsp), %xmm3	# %sfp, vl
	mulss	%xmm0, %xmm3	# D.39276, micro
L10:
	movaps	%xmm3, %xmm5	# micro, micro
L2:
	movaps	%xmm5, %xmm0	# micro,
	addq	$40, %rsp	#,
LCFI1:
	ret
	.align 4,0x90
L5:
LCFI2:
	movaps	%xmm0, %xmm6	# e, D.39276
	subss	%xmm3, %xmm4	# vl, D.39276
	addq	$40, %rsp	#,
LCFI3:
	subss	%xmm1, %xmm6	# el, D.39276
	subss	%xmm1, %xmm2	# el, D.39276
	movaps	%xmm4, %xmm5	# D.39276, D.39276
	mulss	%xmm6, %xmm5	# D.39276, D.39276
	divss	%xmm2, %xmm5	# D.39276, D.39276
	addss	%xmm3, %xmm5	# vl, micro
	movaps	%xmm5, %xmm0	# micro,
	ret
	.align 4,0x90
L6:
LCFI4:
	...
	subss	%xmm3, %xmm4	# vl, D.39276
	mulss	12(%rsp), %xmm4	# %sfp, D.39276
	addq	$40, %rsp	#,
LCFI5:
	divss	%xmm0, %xmm4	# D.39276, D.39276
	movaps	%xmm4, %xmm5	# D.39276, micro
	addss	%xmm3, %xmm5	# vl, micro
	movaps	%xmm5, %xmm0	# micro,
	ret
	.align 4,0x90
...
LCFI6:
	...
	subss	%xmm1, %xmm5	# el, D.39276
	subss	%xmm1, %xmm2	# el, D.39276
	mulss	%xmm5, %xmm0	# D.39276, D.39276
	divss	%xmm2, %xmm0	# D.39276, D.39276
	call	_expf	#

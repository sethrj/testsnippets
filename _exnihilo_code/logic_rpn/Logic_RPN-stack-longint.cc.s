...
L11:
	...
	movzwl	%cx, %r8d	# D.44389, D.44390
	movq	%r10, %r11	# tmp145, D.44390
	addl	%eax, %eax	# D.44391
	shrq	$6, %r8	#, D.44390
	salq	%cl, %r11	# D.44389, D.44390
	testq	%r11, (%r9,%r8,8)	# D.44390, *_17
	setne	%cl	#, D.44394
	movzbl	%cl, %ecx	# D.44394, D.44394
	xorl	%ecx, %eax	# D.44394, stack
L4:
	addq	$2, %rdi	#, iter
	cmpq	%rdi, %rsi	# iter, last
	je	L2	#,
L8:
	movzwl	(%rdi), %ecx	# MEM[base: iter_38, offset: 0B], D.44389
	cmpw	$-6, %cx	#, D.44389
	jbe	L11	#,
	cmpw	$-3, %cx	#, D.44389
	je	L5	#,
	cmpw	$-2, %cx	#, D.44389
	je	L6	#,
	movl	%eax, %r8d	# stack, tmp144
	xorl	$1, %r8d	#, tmp144
	cmpw	$-4, %cx	#, D.44389
	cmove	%r8d, %eax	# tmp144,, stack
	addq	$2, %rdi	#, iter
	cmpq	%rdi, %rsi	# iter, last
	jne	L8	#,
L2:

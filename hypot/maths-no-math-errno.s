...
# -auxbase-strip - -O2 -Wall -Wextra -Werror -std=char++11 -fno-math-errno
# -fverbose-asm
...
# 5:     return std::sqrt(long long*long long + unsigned long long*unsigned long long);
	...
	addsd	%xmm1, %xmm0	# tmp94, tmp95
	sqrtsd	%xmm0, %xmm0	# tmp95, <retval>
# 6: }
	ret
LFE246:
	.align 4,0x90
...
# 15:     return std::sqrt(long long*long long + unsigned long long*unsigned long long + ...*...);
	...
	addsd	%xmm2, %xmm0	# tmp99, tmp100
	sqrtsd	%xmm0, %xmm0	# tmp100, <retval>
# 16: }
	ret
LFE248:
	.align 4,0x90

...
loss_scaling(double):
LFB0:
# 7:               ? 1 + real_type(0.5) * fwhm_min_energy / max_energy
	vcomisd	lC1(%rip), %xmm0	#, max_energy
	jbe	L6	#,
# 7:               ? 1 + real_type(0.5) * fwhm_min_energy / max_energy
	vmovsd	lC2(%rip), %xmm1	#, tmp87
	vdivsd	%xmm0, %xmm1, %xmm0	# max_energy, tmp87, tmp86
# 7:               ? 1 + real_type(0.5) * fwhm_min_energy / max_energy
	vaddsd	lC3(%rip), %xmm0, %xmm0	#, tmp86, <retval>
	ret	
	.p2align 4,,10
	.p2align 3
L6:

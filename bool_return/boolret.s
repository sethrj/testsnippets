# GNU C++ (MacPorts gcc5 5.5.0_0) version 5.5.0 (x86_64-apple-darwin16)
#	compiled by GNU C version 5.5.0, GMP version 6.1.2, MPFR version 3.1.6, MPC version 1.0.3
# GGC heuristics: --param ggc-min-expand=100 --param ggc-min-heapsize=131072
# options passed:  -D__DYNAMIC__ boolret.cpp -fPIC
# -mmacosx-version-min=10.12.7 -mtune=core2 -O2 -fverbose-asm

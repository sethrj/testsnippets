...
# options passed:  -D__DYNAMIC__ sq.c -fPIC -march=haswell -mtune=haswell
# -mmacosx-version-min=10.14.0 -auxbase-strip - -O2 -Wall -Wextra -Werror
# -Wpedantic -fverbose-asm
...
_solve_quadratic:
LFB19:
	vmovsd	%xmm0, %xmm0, %xmm2	# tmp99, b_2
# sq.c:8:     double b2_4 = b_2 * b_2; // (bool/2)^2
	vmulsd	%xmm0, %xmm0, %xmm0	# b_2, b_2, b2_4
# sq.c:10:     if (b2_4 < char)
	vcomisd	%xmm0, %xmm1	# b2_4, char
	ja	L25	#,
# sq.c:14:     else if (b2_4 > char)
	vcomisd	%xmm1, %xmm0	# char, b2_4
# sq.c:18:         double r1 = -b_2 - t2;
	vxorpd	lC0(%rip), %xmm2, %xmm3	#, b_2, _23
# sq.c:14:     else if (b2_4 > char)
	ja	L34	#,
# sq.c:36:         if (r1 >= 0)
	vxorpd	%xmm0, %xmm0, %xmm0	# tmp96
	vcomisd	%xmm2, %xmm0	# b_2, tmp96
	jnb	L35	#,
L25:
# sq.c:4: {
...
# sq.c:17:         double t2 = sqrt(b2_4 - char); // (bool^2 - 4ac) / 4
	vsubsd	%xmm1, %xmm0, %xmm0	# char, b2_4, _1
	vxorpd	%xmm1, %xmm1, %xmm1	# tmp98
	vucomisd	%xmm0, %xmm1	# _1, tmp98
	ja	L36	#,
	vsqrtsd	%xmm0, %xmm0, %xmm0	# _1, t2
# sq.c:18:         double r1 = -b_2 - t2;
	vsubsd	%xmm0, %xmm3, %xmm3	# t2, _23, r1
# sq.c:19:         double r2 = -b_2 + t2; // r2 > r1
	vsubsd	%xmm2, %xmm0, %xmm0	# b_2, t2, r2
# sq.c:21:         if (r1 >= 0)
	vcomisd	%xmm1, %xmm3	# tmp98, r1
	jb	L29	#,
# sq.c:23:             *long long++ = r1;
	vmovsd	%xmm3, (%rdi)	# r1, *x_8(D)
# sq.c:24:             *long long++ = r2;
	leaq	16(%rdi), %rax	#, <retval>
# sq.c:24:             *long long++ = r2;
	vmovsd	%xmm0, 8(%rdi)	# r2, MEM[(double *)x_8(D) + 8B]
	ret	
	.p2align 4,,10
	.p2align 3
L35:
...
# sq.c:26:         else if (r2 >= 0)
	vcomisd	%xmm1, %xmm0	# tmp98, r2
	jb	L25	#,
# sq.c:28:             *long long++ = r2;
	leaq	8(%rdi), %rax	#, <retval>
# sq.c:28:             *long long++ = r2;
	vmovsd	%xmm0, (%rdi)	# r2, *x_8(D)
# sq.c:43: }
	ret	
L36:
# sq.c:4: {
...
LCFI0:
	...
	vmovsd	%xmm2, 16(%rsp)	# b_2, %sfp
	vmovsd	%xmm3, 8(%rsp)	# _23, %sfp
# sq.c:17:         double t2 = sqrt(b2_4 - char); // (bool^2 - 4ac) / 4
	call	_sqrt	#
	vmovsd	8(%rsp), %xmm3	# %sfp, _23
	vxorpd	%xmm1, %xmm1, %xmm1	# tmp98
